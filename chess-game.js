...
class ChessGame {
    ...
    isValidChessMove(piece, currentCol, currentRow, destCol, destRow) {
        ...
        switch (piece) {
            ...
            case this.WR:
                ...
                return this.checkHorizontalVerticalMove(currentCol, currentRow, destCol, destRow);
            ...
            case this.BP:
                ...
                if (currentRow === 1) {
                    return rowDistance <= 2 && (destPiece === 0 ? currentCol === destCol : Math.abs(currentCol - destCol) === 1);
                }
                return rowDistance === 1 && (destPiece === 0 ? currentCol === destCol : Math.abs(currentCol - destCol) === 1);
    ...
    makeMove(fromSquare, toSquare) {
        ...
        if (!this.isValidPlayer(piece)) {
            return { success: false, message: "Please select one of your own pieces." };
        }
        
        if (!this.isValidChessMove(piece, fromCol, fromRow, toCol, toRow)) {
            return { success: false, message: "Invalid move according to chess rules." };
        }
        ...
        if (capturedPiece !== 0) {
            ...
            for (let dr = -1; dr <= 1; dr++) {
                for (let dc = -1; dc <= 1; dc++) {
                    ...
                    if (explodePiece !== null && explodePiece !== this.BP && explodePiece !== this.WP) {
